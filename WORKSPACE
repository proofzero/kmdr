...
go_repository(
    ...
    sum = "h1:eSSMy699s/+8g+uJlliNDHq4wZFduENHlKGGvGr/tCo=",
    version = "v0.0.0-20210707160108-1c3c416465b0",
)
...
go_repository(
    ...
    sum = "h1:Kgs5nmbQVuUAug2PXQ27hu9MSCv8uJTnrmxZj9Lj5lc=",
    version = "v0.0.0-20210610141715-e7a9b787a5a4",
)
